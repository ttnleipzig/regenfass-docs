...
此示例说明如何将 HC-SR04 传感器组装到微控制器。传感器通过 4 针电缆连接到微控制器。黄色电缆是触发电缆。蓝色电缆是回波电缆。红色电缆是 5V 电缆。黑色电缆是地线。
