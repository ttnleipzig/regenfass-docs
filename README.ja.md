...
データをサーバーに送信するには、ゲートウェイが必要です。次のゲートウェイがサポートされており、推奨されています。

| 部                                                    | 説明 |
| ---------------------------------------------------- | -- |
| ![TTN gateway](_media/hardware/hardware-gateway.svg) |    |

[ｈっｔｐｓ：／／あｍｚん。と／４３ｘＳ２Ｄｇ](https://amzn.to/43xS2Dg)
