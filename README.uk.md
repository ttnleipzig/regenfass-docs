...
?> Оригінальний документ написано в[англійська](README.md). Переклад виконує Google Translate. Якщо ви знайшли якісь помилки, спробуйте їх проігнорувати. Якщо ви хочете допомогти, ви можете створити запит на отримання.
