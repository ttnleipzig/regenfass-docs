...
-   Ви контактуєте з SAP. Запитання про те, як SAP може підтримувати DTracing.
-   передати їм завдання.
-   EDEKA це знає.
