...
Швидкий старт створений для людей, які хочуть почати відразу. Він не створений для людей, які хочуть зрозуміти, як це працює. Якщо ви хочете зрозуміти, як це працює, ви можете прочитати[documentation](https://ttnleipzig.github.io/regenfass-docs/). Якщо ви хочете почати відразу, виконайте такі дії:
