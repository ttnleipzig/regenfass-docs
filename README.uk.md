...
1.  **[Швидкий початок](#Quickstart)**
    1.  [вступ](#Quickstart-Introduction)
    2.  [Обладнання](#Quickstart-Hardware)
    3.  [Програмне забезпечення Flash](#Quickstart-Flash-software)
2.  **[Обладнання](#Hardware)**
    1.  [Датчики](#Sensors)
...
| <img src="_media/hardware/hardware-solarpanel.png" /> | **Сонячна панель:**Сонячна панель не потрібна, але разом з акумулятором це найкращий варіант. Сонячна панель водонепроникна і може використовуватися під дощем. Він виготовлений з полікристалічного кремнію і має потужність 2 Вт. Якщо ви купуєте сонячну панель, ви повинні переконатися, що вона має вихідну напругу 5 В з принаймні 400 мА.                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
